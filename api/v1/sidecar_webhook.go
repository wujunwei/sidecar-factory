...
// +kubebuilder:webhook:path=/mutate-injection-wujunwei-io-v1-sidecar,mutating=true,failurePolicy=fail,groups=injection.wujunwei.io,resources=sidecars,verbs=create;update,versions=v1,name=msidecar.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-injection-wujunwei-io-v1-sidecar,mutating=false,failurePolicy=fail,groups=injection.wujunwei.io,resources=sidecars,versions=v1,name=vsidecar.kb.io

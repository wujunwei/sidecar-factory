...
import (
	...
	"github.com/wujunwei/sidecar-factory/controllers"
...
func init() {
	...
	utilruntime.Must(injectionv1.AddToScheme(scheme))
...
func main() {
	...
	mgr.GetWebhookServer().Register("/mutate-v1-pod", &webhook.Admission{Handler: &controllers.PodSidecar{Client: mgr.GetClient()}})
